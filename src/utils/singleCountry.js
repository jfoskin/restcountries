...
export const  singleCountryDetails = async(name) => {
    try {
       ...
       //fetching country by name 
        ...
        const nativeNameDetailLabel = document.createElement('label')
        const nativeNameDetail = document.createElement('p')
        const populationDetailLabel = document.createElement('label')
        const populationDetails = document.createElement('p')
        const regionDetailLabel = document.createElement('label')
        const regionDetails = document.createElement('p')
        const subRegionDetailsLabel = document.createElement('label')
        const subRegionDetails = document.createElement('p')
        const capitalDetailsLabel = document.createElement('label')
        const capitalDetails = document.createElement('p')
        const domainDetailsLabel = document.createElement('label')
        const domainDetails = document.createElement('p')
        const currencyDetailsLabel = document.createElement('label')
        const currencyDetails = document.createElement('p')
        const languageDetailsLabel = document.createElement('label')
        const languageDetails = document.createElement('p')
        const borderCountryDetailsLabel = document.createElement('label')
